/*
* Set an onformsubmit trigger tied to function collectInfo
...
var rawDataSheet = ss.getSheetByName('Form Responses 1');
...
//  Utilities.sleep(1000);
  ...
  var partyColumn = ['Corrective Action 1 Responsible Party',
                     ...
                     'Corrective Action 3 Responsible Party']; //load in the column names for the responsible party columns
...
function sendEmail(row,email,body,parties) {
  ...
  var emailList = setupSheet.getRange("H27:I200").getValues();
