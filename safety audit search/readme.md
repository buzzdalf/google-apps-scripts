This script helps the user find specific audits based on criteria.  It runs from a custom menu.  It then opens up a sidebar for user entry and executes the searches from the sidebar.
